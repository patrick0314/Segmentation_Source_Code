...
# --------------------------------------------------------------------------------
def segment(in_image, out_path, sigma, k, min_size):
    ...
    plt.imshow(in_image.astype(np.uint8))
...
if __name__ == "__main__":
    ...
    for filename in filenames:
        ...
        input_image = np.array(img).astype(float)
        print("Loading is done.")
        print("processing...")
        segment(input_image, os.path.join(output_folder, filename), sigma, k, min)
